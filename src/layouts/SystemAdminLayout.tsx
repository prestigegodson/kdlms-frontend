import { Building2, FileText, LayoutDashboard, LifeBuoy, Package } from "lucide-react";
...
// Support Contact lives in the drawer behind "More" below `lg` - the first
// item in this portal to do so.
