                ...
                <p className="mt-2 text-sm text-slate-500">
                  {system.configured
                    ? system.assessmentMode === "NUMERIC"
                      ? `Midterm ${system.quizWeight}% · Exam ${system.examWeight}% · ${system.boundaries.length} grade${system.boundaries.length === 1 ? "" : "s"}${system.showPosition ? "" : " · Position hidden on reports"}${system.showMidtermGrade ? "" : " · Mid-term grade hidden"}`
